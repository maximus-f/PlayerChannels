...
import me.perotin.playerchannels.objects.inventory.actions.ChatroomModeratorAction;
...
public class ChatroomModeratorMenu extends StaticMenu {
    ...
    private PlayerChannelUser toPunish; // Player that is being punished in the menu
    ...
    public ChatroomModeratorMenu(Player moderator, PlayerChannelUser toPunish, Chatroom chatroom) {
